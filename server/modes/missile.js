...
export const initializeMissile = (game) => {
...
export const updateMissileState = (game, now) => {
...
export const handleMissileAction = (game, action, user) => {
    ...
    switch (type) {
        ...
        case 'LAUNCH_MISSILE':
            ...
            if (game.boardState[from.y][from.x] !== myPlayerEnum)
