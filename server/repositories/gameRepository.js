...
export const saveGame = async (db, game) => {
    ...
    await db.run(`INSERT OR REPLACE INTO live_games (${columnNames}) VALUES (${paramNames})`, values);
};
