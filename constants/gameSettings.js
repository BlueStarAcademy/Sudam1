import { GameMode, DiceGoVariant, Player, AlkkagiPlacementType, AlkkagiLayoutType } from '../types.js';
...
export const SPEED_TIME_LIMITS = [
    { value: 1, label: '1분' },
    { value: 3, label: '3분' },
    { value: 5, label: '5분' },
    { value: 10, label: '10분' },
...
export const ALKKAGI_ROUNDS = [1, 2, 3];
export const CURLING_ROUNDS = [1, 2, 3];
...
export const BATTLE_PLACEMENT_ZONES = {
    [Player.Black]: [
