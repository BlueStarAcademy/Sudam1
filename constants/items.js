...
export const GRADE_LEVEL_REQUIREMENTS = {
    normal: 1,
    uncommon: 1,
    rare: 5,
    epic: 12,
...
export const EQUIPMENT_POOL = [
    // --- Fans (부채) ---
    { name: '푸른 바람 부채', slot: 'fan', image: 'images/equipments/Fan1.png', grade: 'normal', stars: 0, type: 'equipment', description: '가볍고 실용적인 대나무 부채입니다.' },
    { name: '은결 바람 부채', slot: 'fan', image: 'images/equipments/Fan2.png', grade: 'uncommon', stars: 0, type: 'equipment', description: '부드러운 비단으로 만들어져 손에 잘 감깁니다.' },
    { name: '화염 바람 부채', slot: 'fan', image: 'images/equipments/Fan3.png', grade: 'rare', stars: 0, type: 'equipment', description: '학의 날개처럼 우아하게 펼쳐지는 명인의 부채입니다.' },
    { name: '서리 바람 부채', slot: 'fan', image: 'images/equipments/Fan4.png', grade: 'epic', stars: 0, type: 'equipment', description: '묵직한 강철로 만들어져 위급 시 무기로도 사용할 수 있습니다.' },
    { name: '용비 바람 부채', slot: 'fan', image: 'images/equipments/Fan5.png', grade: 'legendary', stars: 0, type: 'equipment', description: '백 개의 하얀 깃털로 만들어진 전설적인 부채입니다.' },
    { name: '천룡 바람 부채', slot: 'fan', image: 'images/equipments/Fan6.png', grade: 'mythic', stars: 0, type: 'equipment', description: '바람을 일으켜 판세를 뒤엎는 신화 속 부채입니다.' },
    // --- Boards (바둑판) ---
    { name: '새싹 바둑판', slot: 'board', image: 'images/equipments/Board1.png', grade: 'normal', stars: 0, type: 'equipment', description: '초심자들이 사용하기 좋은 가벼운 오동나무 바둑판입니다.' },
    { name: '단풍결 바둑판', slot: 'board', image: 'images/equipments/Board2.png', grade: 'uncommon', stars: 0, type: 'equipment', description: '아름다운 결을 가진 비자나무로 만든 고급 바둑판입니다.' },
    { name: '산호결 바둑판', slot: 'board', image: 'images/equipments/Board3.png', grade: 'rare', stars: 0, type: 'equipment', description: '최고급 신비자 나무로 만들어져 돌을 놓는 소리가 청아합니다.' },
    { name: '흑단 바둑판', slot: 'board', image: 'images/equipments/Board4.png', grade: 'epic', stars: 0, type: 'equipment', description: '뜨거운 열정으로 다듬어진 화산암 바둑판입니다.' },
    { name: '용문 바둑판', slot: 'board', image: 'images/equipments/Board5.png', grade: 'legendary', stars: 0, type: 'equipment', description: '천 년의 세월을 간직한 금강송으로 만들어진 전설의 바둑판입니다.' },
    { name: '천룡 바둑판', slot: 'board', image: 'images/equipments/Board6.png', grade: 'mythic', stars: 0, type: 'equipment', description: '밤하늘의 별들을 수놓은 듯한 신화적인 바둑판입니다.' },
    // --- Tops (상의) ---
    { name: '봄빛 도복 상의', slot: 'top', image: 'images/equipments/Top1.png', grade: 'normal', stars: 0, type: 'equipment', description: '수련에 집중하기 좋은 편안한 상의입니다.' },
    { name: '여름빛 도복 상의', slot: 'top', image: 'images/equipments/Top2.png', grade: 'uncommon', stars: 0, type: 'equipment', description: '오랜 수련에도 해지지 않는 질긴 도복입니다.' },
    { name: '가을빛 도복 상의', slot: 'top', image: 'images/equipments/Top3.png', grade: 'rare', stars: 0, type: 'equipment', description: '고요한 기품이 느껴지는 선비의 도포입니다.' },
    { name: '겨울빛 도복 상의', slot: 'top', image: 'images/equipments/Top4.png', grade: 'epic', stars: 0, type: 'equipment', description: '날카로운 승부를 위해 만들어진 검객의 복장입니다.' },
    { name: '용비 도복 상의', slot: 'top', image: 'images/equipments/Top5.png', grade: 'legendary', stars: 0, type: 'equipment', description: '황제의 위엄을 상징하는 용무늬가 수놓아져 있습니다.' },
    { name: '천룡 도복 상의', slot: 'top', image: 'images/equipments/Top6.png', grade: 'mythic', stars: 0, type: 'equipment', description: '입는 자에게 신의 가호를 내린다는 신화 속 의상입니다.' },
    // --- Bottoms (하의) ---
    { name: '봄빛 도복 하의', slot: 'bottom', image: 'images/equipments/Bottom1.png', grade: 'normal', stars: 0, type: 'equipment', description: '움직임이 편한 수련용 바지입니다.' },
    { name: '여름빛 도복 하의', slot: 'bottom', image: 'images/equipments/Bottom2.png', grade: 'uncommon', stars: 0, type: 'equipment', description: '쉽게 닳지 않는 튼튼한 재질의 바지입니다.' },
    { name: '가을빛 도복 하의', slot: 'bottom', image: 'images/equipments/Bottom3.png', grade: 'rare', stars: 0, type: 'equipment', description: '도포와 한 벌을 이루는 고급 비단 바지입니다.' },
    { name: '겨울빛 도복 하의', slot: 'bottom', image: 'images/equipments/Bottom4.png', grade: 'epic', stars: 0, type: 'equipment', description: '어떠한 움직임에도 방해받지 않는 검객의 하의입니다.' },
    { name: '용비 도복 하의', slot: 'bottom', image: 'images/equipments/Bottom5.png', grade: 'legendary', stars: 0, type: 'equipment', description: '용포와 한 벌을 이루는 최고급 비단으로 만들어졌습니다.' },
    { name: '천룡 도복 하의', slot: 'bottom', image: 'images/equipments/Bottom6.png', grade: 'mythic', stars: 0, type: 'equipment', description: '구름을 엮어 만들었다다는 신화 속 하의입니다.' },
    // --- Bowls (바둑통) ---
    { name: '가벼운 나무통', slot: 'bowl', image: 'images/equipments/StoneBox1.png', grade: 'normal', stars: 0, type: 'equipment', description: '가볍고 저렴한 플라스틱 바둑통입니다.' },
    { name: '단단한 대나무통', slot: 'bowl', image: 'images/equipments/StoneBox2.png', grade: 'uncommon', stars: 0, type: 'equipment', description: '은은한 향이 나는 대추나무로 만든 바둑통입니다.' },
    { name: '홍목 바둑통', slot: 'bowl', image: 'images/equipments/StoneBox3.png', grade: 'rare', stars: 0, type: 'equipment', description: '아름다운 붉은 빛을 띠는 장미목으로 만들어졌습니다.' },
    { name: '흑단 바둑통', slot: 'bowl', image: 'images/equipments/StoneBox4.png', grade: 'epic', stars: 0, type: 'equipment', description: '기이하고 아름다운 무늬를 가진 괴목으로 만든 희귀한 바둑통입니다.' },
    { name: '용린 바둑통', slot: 'bowl', image: 'images/equipments/StoneBox5.png', grade: 'legendary', stars: 0, type: 'equipment', description: '용이 섬세하게 조각된 최고급 자단목 바둑통입니다.' },
    { name: '천룡 바둑통', slot: 'bowl', image: 'images/equipments/StoneBox6.png', grade: 'mythic', stars: 0, type: 'equipment', description: '고대 신의 유물을 담았다고 전해지는 신비로운 함입니다.' },
    // --- Stones (바둑돌) ---
    { name: '흑백 새싹돌', slot: 'stones', image: 'images/equipments/Stone1.png', grade: 'normal', stars: 0, type: 'equipment', description: '가볍고 저렴한 플라스틱 바둑돌입니다.' },
    { name: '은빛 결돌', slot: 'stones', image: 'images/equipments/Stone2.png', grade: 'uncommon', stars: 0, type: 'equipment', description: '강가에서 주운 매끄러운 조약돌로 만든 바둑돌입니다.' },
    { name: '홍옥 바둑돌', slot: 'stones', image: 'images/equipments/Stone3.png', grade: 'rare', stars: 0, type: 'equipment', description: '차가운 빛을 내는 흑요석으로 정교하게 깎아 만들었습니다.' },
    { name: '백옥 바둑돌', slot: 'stones', image: 'images/equipments/Stone4.png', grade: 'epic', stars: 0, type: 'equipment', description: '영롱한 빛을 내는 청옥과 백옥으로 만들어진 바둑돌입니다.' },
    { name: '용안 바둑돌', slot: 'stones', image: 'images/equipments/Stone5.png', grade: 'legendary', stars: 0, type: 'equipment', description: '해와 달, 별의 기운을 담아 벼려낸 전설적인 바둑돌입니다.' },
    { name: '천룡 바둑돌', slot: 'stones', image: 'images/equipments/Stone6.png', grade: 'mythic', stars: 0, type: 'equipment', description: '밤하늘의 은하수를 담아놓은 듯한 신화 속 바둑돌입니다.' },
];
export const CONSUMABLE_ITEMS = [
    { name: '장비 상자 I', description: '일반~희귀 등급 장비 획득', type: 'consumable', slot: null, image: '/images/Box/EquipmentBox1.png', grade: 'normal' },
    { name: '장비 상자 II', description: '일반~에픽 등급 장비 획득', type: 'consumable', slot: null, image: '/images/Box/EquipmentBox2.png', grade: 'uncommon' },
    { name: '장비 상자 III', description: '고급~전설 등급 장비 획득', type: 'consumable', slot: null, image: '/images/Box/EquipmentBox3.png', grade: 'rare' },
    { name: '장비 상자 IV', description: '희귀~신화 등급 장비 획득', type: 'consumable', slot: null, image: '/images/Box/EquipmentBox4.png', grade: 'epic' },
    { name: '장비 상자 V', description: '에픽~신화 등급 장비 획득', type: 'consumable', slot: null, image: '/images/Box/EquipmentBox5.png', grade: 'legendary' },
    { name: '장비 상자 VI', description: '전설~신화 등급 장비 획득', type: 'consumable', slot: null, image: '/images/Box/EquipmentBox6.png', grade: 'mythic' },
    { name: '재료 상자 I', description: '하급 ~ 상급 강화석 5개 획득', type: 'consumable', slot: null, image: '/images/Box/ResourceBox1.png', grade: 'normal' },
    { name: '재료 상자 II', description: '하급 ~ 상급 강화석 5개 획득', type: 'consumable', slot: null, image: '/images/Box/ResourceBox2.png', grade: 'uncommon' },
    { name: '재료 상자 III', description: '하급 ~ 상급 강화석 5개 획득', type: 'consumable', slot: null, image: '/images/Box/ResourceBox3.png', grade: 'rare' },
    { name: '재료 상자 IV', description: '중급 ~ 최상급 강화석 5개 획득', type: 'consumable', slot: null, image: '/images/Box/ResourceBox4.png', grade: 'epic' },
    { name: '재료 상자 V', description: '상급 ~ 신비의 강화석 5개 획득', type: 'consumable', slot: null, image: '/images/Box/ResourceBox5.png', grade: 'legendary' },
    { name: '재료 상자 VI', description: '상급 ~ 신비의 강화석 5개 획득', type: 'consumable', slot: null, image: '/images/Box/ResourceBox6.png', grade: 'mythic' },
    { name: '골드 꾸러미1', description: '10 ~ 500 골드 획득', type: 'consumable', slot: null, image: '/images/Box/GoldBox1.png', grade: 'normal' },
    { name: '골드 꾸러미2', description: '100 ~ 1,000 골드 획득', type: 'consumable', slot: null, image: '/images/Box/GoldBox2.png', grade: 'uncommon' },
    { name: '골드 꾸러미3', description: '500 ~ 3,000 골드 획득', type: 'consumable', slot: null, image: '/images/Box/GoldBox3.png', grade: 'rare' },
    { name: '골드 꾸러미4', description: '1,000 ~ 10,000 골드 획득', type: 'consumable', slot: null, image: '/images/Box/GoldBox4.png', grade: 'epic' },
    { name: '다이아 꾸러미1', description: '1 ~ 20 다이아 획득', type: 'consumable', slot: null, image: '/images/Box/DiaBox1.png', grade: 'rare' },
...
export const MATERIAL_ITEMS = {
    '하급 강화석': { name: '하급 강화석', description: '장비 강화에 사용되는 기본 재료.', type: 'material', slot: null, image: '/images/materials/materials1.png', grade: 'normal' },
    '중급 강화석': { name: '중급 강화석', description: '장비 강화에 사용되는 상급 재료.', type: 'material', slot: null, image: '/images/materials/materials2.png', grade: 'uncommon' },
    '상급 강화석': { name: '상급 강화석', description: '장비 강화에 사용되는 최상급 재료.', type: 'material', slot: null, image: '/images/materials/materials3.png', grade: 'rare' },
    '최상급 강화석': { name: '최상급 강화석', description: '장비 강화에 사용되는 희귀 재료.', type: 'material', slot: null, image: '/images/materials/materials4.png', grade: 'epic' },
    '신비의 강화석': { name: '신비의 강화석', description: '장비 강화에 사용되는 고대 재료.', type: 'material', slot: null, image: '/images/materials/materials5.png', grade: 'legendary' },
};
export const gradeBackgrounds = {
...
export const ENHANCEMENT_FAIL_BONUS_RATES = {
    normal: 5,
    uncommon: 4,
    rare: 3,
    epic: 2,
...
export const ENHANCEMENT_GOLD_COSTS_BASE = {
    normal: 100,
    uncommon: 200,
    rare: 300,
    epic: 500,
...
export const calculateEnhancementGoldCost = (grade, currentStars) => {
...
export const MATERIAL_SELL_PRICES = {
    '하급 강화석': 10,
    '중급 강화석': 30,
    '상급 강화석': 50,
    '최상급 강화석': 100,
...
export const MAIN_STAT_DEFINITIONS = {
    fan: {
        isPercentage: true,
        options: {
...
export const SPECIAL_STATS_DATA = {
...
export const MYTHIC_STATS_DATA = {
...
export const GRADE_SUB_OPTION_RULES = {
